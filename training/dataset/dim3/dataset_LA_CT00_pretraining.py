...
class LA_CT00_pretraining_Dataset(Dataset):
    ...
    def preprocess(self, itk_img, itk_lab, name):
        ...
        np.save(f'/media/sharedata/atriumCT/atrium_medFormer/preprocess_pretraining/preprocess/{name}.npy', img)
        np.save(f'/media/sharedata/atriumCT/atrium_medFormer/preprocess_pretraining/preprocess/{name}_gt.npy', lab)
    ...
    def __getitem__(self, idx):
        ...
        np.save(f'/media/sharedata/atriumCT/atrium_medFormer/preprocess_pretraining/augmentation/{idx}.npy', tensor_img.numpy())
        np.save(f'/media/sharedata/atriumCT/atrium_medFormer/preprocess_pretraining/augmentation/{idx}_gt.npy', tensor_lab.numpy())
