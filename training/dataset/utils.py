...
def get_dataset(args, mode, **kwargs):
    ...
    if args.dimension == '2d':
        ...
        elif args.dataset == 'LA_CT00_pretraining':
            from .dim3.dataset_LA_CT00_pretraining import LA_CT00_pretraining_Dataset

            return LA_CT00_pretraining_Dataset(args, mode=mode, k_fold=args.k_fold, k=kwargs['fold_idx'], seed=args.split_seed)
