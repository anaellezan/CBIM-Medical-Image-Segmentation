...
def main():
    ...
    src_path = '/media/sharedata/atriumCT/atrium_nnunet/raw_data/Dataset006_LA_CT00_region_fenetrage/'
    tgt_path = '/media/sharedata/atriumCT/atrium_medFormer/LA_CT00_dataset/'
